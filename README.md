I am a software engineer from the UK, working as the CPU Operating System
Development Lead at [NUVACORE](https://www.nuvacore.ai/).  Previously, I worked at
...
covering application processor firmware, operating systems and virtual platforms
on our custom CPU designs.
...
My [RXV RV32IMA RISC-V](https://github.com/jamieiles/rxv) core is implemented
in SystemVerilog and offers ~2.61 CoreMark/MHz. The core implements the privileged
architecture with SSTC and Sscofpmf extensions and runs mainline Linux. I
implemented a number unique tracing techniques to record and replay execution to
generate ELF core-files for software debug. The core is a scalar design with
parallel execution units and out of order completion, register rename and dynamic
branch prediction.  The system runs on a Spartan 7 FPGA and has been hardened with
OpenLane for the SKY130A process.
